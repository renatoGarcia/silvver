...
PGRCamera::PGRCamera(unsigned frequencia,char* diretorio,double tempoInicial)
{
...
void PGRCamera::Iniciar(unsigned serial)
{    
    for(int i=0; i<NUMERO_BUFFERS; i++)
    {
...
double PGRCamera::CapturarImg(IplImage *iplImgRetorno)
{
    FlyCaptureError erro;
