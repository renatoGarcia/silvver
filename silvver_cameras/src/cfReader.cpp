...
{
  luaParser.readValue(hardware.suffixUid, "suffix_uid");
...
CfReader::readArtkp()
{
  ...
  luaParser.readValue(artkpTargets.prefixUid, "prefix_uid");
...
CfReader::readButterfly()
{
  ...
  luaParser.readValue(butterflyTargets.prefixUid, "prefix_uid");
